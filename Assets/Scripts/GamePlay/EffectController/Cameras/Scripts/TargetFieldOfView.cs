...
public class TargetFieldOfView : AbstractTargetFollower {
	...
	protected override void Start ()
	{
		...
		boundSize = MaxBoundsExtent( target.transform, includeEffectsInSize );
	...
	public override void SetTarget (GameObject newGameObject)
	{
		base.SetTarget (newGameObject);
		boundSize = MaxBoundsExtent( newGameObject.transform, includeEffectsInSize );
	}
